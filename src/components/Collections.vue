        ...
        <template v-if="c.devices.length === 1">
          ...
          >
            ...
            >
              ...
              <div class="mt-3">
                <p
                  v-if="device.compiler && device.firmware.hash !== device.compiler.latestFirmware.hash"
...
const collections = computed(() => organization.value.collections.filter(c => c.devices.length > 0));
